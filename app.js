...
const POPULAR = {
  '🥬 Овощи и фрукты': ['Картофель', 'Помидоры', 'Огурцы', 'Морковь', 'Яблоки', 'Бананы', 'Лук', 'Чеснок', 'Капуста', 'Перец болгарский'],
  '🥩 Мясо и рыба':    ['Курица', 'Говядина', 'Свинина', 'Фарш', 'Лосось', 'Минтай', 'Сосиски', 'Колбаса', 'Индейка', 'Креветки'],
  '🥛 Молочное':       ['Молоко', 'Кефир', 'Сметана', 'Творог', 'Сыр', 'Масло сливочное', 'Йогурт', 'Ряженка', 'Яйца', 'Сливки'],
  '🍞 Хлеб и выпечка': ['Хлеб белый', 'Хлеб чёрный', 'Батон', 'Лаваш', 'Булочки', 'Багет', 'Хлебцы', 'Пита', 'Слойки', 'Круассаны'],
  '🧴 Бытовая химия':  ['Порошок стиральный', 'Средство для посуды', 'Шампунь', 'Зубная паста', 'Туалетная бумага', 'Гель для душа', 'Кондиционер для белья', 'Салфетки', 'Мыло', 'Освежитель воздуха'],
  '🥫 Бакалея':        ['Рис', 'Гречка', 'Макароны', 'Сахар', 'Подсолнечное масло', 'Мука', 'Соль', 'Тушёнка', 'Консервы рыбные', 'Геркулес'],
  '🍬 Сладости':       ['Шоколад', 'Конфеты', 'Печенье', 'Вафли', 'Зефир', 'Мармелад', 'Халва', 'Пастила', 'Торт', 'Пряники'],
  '🧃 Напитки':        ['Вода питьевая', 'Сок', 'Чай', 'Кофе', 'Газировка', 'Компот', 'Морс', 'Энергетик', 'Какао', 'Лимонад'],
  '❓ Другое':         [],
};
