...
const POPULAR = {
  ...
  '🥩 Мясо и рыба':    ['Говядина', 'Индейка', 'Колбаса', 'Креветки', 'Курица', 'Лосось', 'Минтай', 'Свинина', 'Сосиски', 'Тунец', 'Фарш'],
  '🥛 Молочное':       ['Йогурт', 'Кефир', 'Масло сливочное', 'Молоко', 'Простокваша', 'Ряженка', 'Сливки', 'Сметана', 'Сыр', 'Творог', 'Яйца'],
